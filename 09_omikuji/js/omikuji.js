...
window.addEventListener("DOMContentLoaded",
 function() {
  ...
  $(function(){
    ...
    setTimeout(
      function(){
        //agar bolim ozgarmasa
        let popMessage = "いらっしゃい。おみくじ引いてって"
        this.window.aler(popMessage);
      },
      "5000"
    );
  }, false
...
bnt1.addEventListener("click",
  function() {
    bnt1.style.transition = "1s";
    let resultText = ["大吉!!!!!","吉!!!!","中吉!!!","小吉!!","末吉!","凶。。"];
    let resultColor = ["#ff0000", "#c71585","#ff1493","#ff69b4","#ff8c00", "#1090ff"];
    ...
    bnt1.textContent = resultText[n];
    bnt1.style.color = resultColor[n];
    bnt1.style.fontSize = resultFontSize[n];
